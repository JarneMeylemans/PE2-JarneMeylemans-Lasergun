...
{
	HAL_UART_Transmit(pc_uart,(uint8_t *)string,sizeof(string),200);
}

void Uart_Transmit_ESP(char * string)
{
	HAL_UART_Transmit(wifi_uart,(uint8_t *)string,sizeof(string),200);
}
...
void ESP_Init (char *SSID, char *PASSWD)
{
	...
	Uart_Transmit_ESP("AT+RST\r\n");
	//Uart_sendstring("AT+RST\r\n", wifi_uart);
	Uart_Transmit_PC("RESETTING.\r\n");
	HAL_Delay(500);
	//printf("RESETTING.");
	...
	/********* AT **********/
	Uart_Transmit_ESP("AT\r\n");
	while(!(Wait_for("AT\r\r\n\r\nOK\r\n", wifi_uart)));
	Uart_Transmit_PC("AT---->OK\n\n");
