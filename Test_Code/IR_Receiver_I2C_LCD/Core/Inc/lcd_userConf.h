...
*@val: Default: 0x4E
*/
//uint8_t i2cDeviceAddr1 = 0x4e; //* LCD i2c module default address, change i2c device address here, default is 0x4E.
...
*/
static  uint8_t BFR_MAX = 100; //*Change it if you want to use a different value.
